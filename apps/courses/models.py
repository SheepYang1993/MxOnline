...
class Course(models.Model):
    ...
    degress = models.CharField(choices=(("cj", u"初级"), ("zj", u"中级"), ("gj", u"高级")), max_length=2,
                               verbose_name=u"课程难度")
...
class CourseResource(models.Model):
    ...
    download = models.FileField(upload_to="courses/resource/%Y/%m", max_length=100, verbose_name=u"资源文件")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
